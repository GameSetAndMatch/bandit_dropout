...
#
    #
    #EgreedyDropout.run_experience(exp_name="Acc_Increase_egreedy_batch",reward_type="accuracy_increase",per_batch=True, nombre_epoch=nb_epoch,nombre_entrainement=nb_entrainement,seed=seed)
    #EgreedyDropout.run_experience(exp_name="Acc_egreedy_batch",reward_type="accuracy",per_batch=True,nombre_epoch=nb_epoch,nombre_entrainement=nb_entrainement,seed=seed) 
    EgreedyDropout.run_experience(exp_name="loss_Increase_egreedy_batch",reward_type="loss_increase",per_batch=True,nombre_epoch=nb_epoch,nombre_entrainement=nb_entrainement,seed=seed)
    EgreedyDropout.run_experience(exp_name="loss_egreedy_batch",reward_type="loss",per_batch=True,nombre_epoch=nb_epoch,nombre_entrainement=nb_entrainement,seed=seed)
